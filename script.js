function CalendarApp(date) {
  ...
  this.quotes = ['Keep Your Hands Off My Lobby Boy!', 'To Be Frank, I Think His World Had Vanished Long Before He Ever Entered It.', 'We Were Happy Here, For A Little While.', 'Did He Just Throw My Cat Out Of The Window?', 'What Happened, My Dear Zero, Is I Beat The Living S**T Out Of A Sniveling Little Runt Called Pinky Bandinski.', "I knew there was something fishy. We never got the cause of death. She's Been Murdered, And You Think I Did It.", "I Don't Know What Sort Of Cream They've Put On You Down At The Morgue, But I Want Some.", "I've Had Older.", "You see, there are still faint glimmers of civilization left in this barbaric slaughterhouse that was once known as humanity. Indeed, That's What We Provide In Our Own Modest, Humble, Insignificant... Oh F**K It.", 'She Needs Me, And I Need You, To Help Me With My Bags And So On.', "I must say, I find that girl utterly delightful. Flat as a board, enormous birthmark the shape of Mexico over half her face, sweating for hours on end in that sweltering kitchen, while Mendl, genius though he is, looms over her like a hulking gorilla. Yet without question, without fail, always and invariably, she's exceedingly lovely.", "Serge X, missing. Deputy Kovacs, also missing. Madame D, dead. Boy With Apple, stolen. By us. Dmitri and Jopling, ruthless, cold-blooded savages. Gustave H, at large. What else?", "Zero, confused, indeed. The plot thickens, as they say. Why, by the way? Is it a soup metaphor?", "Well, I've never been accused of that before, but I appreciate the sentiment.", "Are you Monsieur Gustave of the Grand Budapest Hotel in Nebelsbad? Uh-huh", "I'll never part with it. It reminded her of me; it will remind me of her, always. I'll die with this picture above my bed. See the resemblance?", "What is a lobby boy? A lobby boy is completely invisible, yet always in sight. A lobby boy remembers what people hate. A lobby boy anticipates the client's needs before the needs are needed. A lobby boy is, above all, discreet to a fault. Our guests know that their deepest secrets, some of which are frankly rather unseemly, will go with us to our graves. So keep your mouth shut, Zero.", "If I die first, and I almost certainly will, you will be my sole heir. There's not much in the kitty, except a set of ivory-backed hairbrushes and my library of romantic poetry, but when the time comes, these will be yours. Along with whatever we haven't already spent on whores and whiskey.", "The beginning of the end of the end of the beginning has begun. A sad finale played off-key on a broken-down saloon piano in the outskirts of a forgotten ghost town. I'd rather not bear witness to such blasphemy.", "Very good! I'm going to stop you there because the alarm has sounded, but remember where we left off, because I insist you finish later!", "This is van Hoytl's exquisite portrayal of a beautiful boy on the cusp of manhood. Blond, smooth skin as white as that milk, of impeccable provenance. One of the last in private hands, and unquestionably the best. It's a masterpiece. The rest of this sh*t is worthless junk.", "Very good; you've got a wonderful line, Ludwig! This shows great artistic promise.", "How does one come by front row aisle seats for a first night at the Opera Toscana with one day's notice? How does one arrange a private viewing of the tapestry collection at the Royal Saxon Gallery? How does one secure a corner table at Chez Dominique on a Thursday?", "Give me your hand. You've nothing to fear. You're always anxious before you travel. I admit you appear to be suffering a more acute attack on this occasion, but truly and honestly... oh, dear God, what have you done to your fingernails?", "This diabolical varnish; the color is completely wrong!", "I was perhaps for a time considered the best lobby boy we ever had at the Grand Budapest. I think I can say that. This one finally surpassed me. Although I must say, I am an exceptional teacher."];
  this.apts = [
    {
...
CalendarApp.prototype.showEventsCreateElesView = function(events) {
  ...
  events.forEach(function(event){
    ...
    // li.innerHtml
    var html = "<span class='start-time'>" + _start.toLocaleTimeString(navigator.language,{hour: '2-digit', minute:'2-digit'}) + "</span> <large>TO</large> ";
